...
import db from '../../datastore' //数据库信息
import axios from 'axios'
import pkg from '../../../package.json'
const version = pkg.version
const release = 'https://api.github.com/repos/GetHere/sunrunIM/releases/latest'
const downloadUrl = 'https://github.com/GetHere/sunrunIM/releases/latest'
